...
object ConfigGenerator extends App {
	...
	new GSConfigGenerator(gsConfig).generate
	new LSConfigGenerator(lsConfig).generate
}

private class GSConfigGenerator(config : File) {
...
private class LSConfigGenerator(config : File) {
