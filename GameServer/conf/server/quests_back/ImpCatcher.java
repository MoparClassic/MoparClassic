...
public class ImpCatcher extends Quest {
	...
	private static final String[] FIRST_MENU = new String[] {
			"No way you crazy bastard", "Sure, why not" };
					...
					public void action() {
						...
						addSingleEvent(new SingleEvent(player,
							...
							public void action() {
								...
								npc.blockedBy(player);
								sendChat(
										"What? Huh? Get out of the way you fool!",
										npc, player);
								addSingleEvent(new SingleEvent(player,
										DEFAULT_EVENT_DELAY) {
									public void action() {
										player.setBusy(true);
										npc.blockedBy(player);
										sendChat("You shot me you stupid sod",
												player, npc);
										addSingleEvent(new SingleEvent(player,
												DEFAULT_EVENT_DELAY) {
											public void action() {
												...
												addSingleEvent(new SingleEvent(
													...
													public void action() {
														...
														npc.blockedBy(player);
														sendChat(
																"Yeah it did. You burnt my sleeve.",
																player, npc);
														addSingleEvent(new SingleEvent(
																player,
																DEFAULT_EVENT_DELAY) {
															public void action() {
																...
																npc
																		.blockedBy(player);
																sendChat(
																		"Collateral damage. A necessary casualty.",
																		npc,
																		player);
																addSingleEvent(new SingleEvent(
																		player,
																	...
																	public void action() {
																		sendChat(
																				"Your sleeve is expendable in this war",
																				npc,
																				player);
																		addSingleEvent(new SingleEvent(
																				player,
																				...
																				addSingleEvent(new SingleEvent(
																					...
																					public void action() {
																						...
																						npc
																								.blockedBy(player);
																						sendChat(
																								"Well the war against those nasty little imps of course",
																								npc,
																								player);
																						addSingleEvent(new SingleEvent(
																								player,
																							...
																							public void action() {
																								...
																								npc
																										.blockedBy(player);
																								sendChat(
																										"Imps? What threat could they possibly pose?",
																										player,
																										npc);
																								addSingleEvent(new SingleEvent(
																										player,
																									...
																									public void action() {
																										...
																										npc
																												.blockedBy(player);
																										sendChat(
																												"Those little bastards stole my beads!",
																												npc,
																												player);
																										addSingleEvent(new SingleEvent(
																												player,
																												...
																												addSingleEvent(new SingleEvent(
																													...
																													public void action() {
																														...
																														npc
																																.blockedBy(player);
																														sendChat(
																																"Why, absolutely nothing. It's the principle of the matter.",
																																npc,
																																player);
																														addSingleEvent(new SingleEvent(
																																player,
																															...
																															public void action() {
																																...
																																npc
																																		.blockedBy(player);
																																sendChat(
																																		"Surely it can't be that hard to get them to give them back",
																																		player,
																																		npc);
																																addSingleEvent(new SingleEvent(
																																		player,
																																	...
																																	public void action() {
																																		...
																																		npc
																																				.blockedBy(player);
																																		sendChat(
																																				"Oh really? Why don't you try and get them back then",
																																				npc,
																																				player);
																																		addSingleEvent(new SingleEvent(
																																				player,
																																				...
																																				addSingleEvent(new SingleEvent(
																																					...
																																					public void action() {
																																						...
																																						npc
																																								.blockedBy(player);
																																						sendChat(
																																								"Free? Nonsense. I'd be happy to reward you.",
																																								npc,
																																								player);
																																						addSingleEvent(new SingleEvent(
																																								player,
																																										...
																																										addSingleEvent(new SingleEvent(
																																											...
																																											public void action() {
																																												...
																																												player
																																														.setBusy(true);
																																												sendChat(
																																														"How about it? Would you help an old wizard out?",
																																														npc,
																																														player);
																																																					...
																																																					addSingleEvent(new SingleEvent(
																																																						...
																																																						public void action() {
																																																							...
																																																							npc
																																																									.blockedBy(player);
																																																							sendChat(
																																																									"There are four beads! Red, white, black, yellow and black.",
																																																									npc,
																																																									player);
																																																							addSingleEvent(new SingleEvent(
																																																									player,
																																																									...
																																																									addSingleEvent(new SingleEvent(
																																																										...
																																																										public void action() {
																																																											...
																																																											npc
																																																													.blockedBy(player);
																																																											sendChat(
																																																													"I'll come back when I get the beads...",
																																																													player,
																																																													npc);
																																																											addSingleEvent(new SingleEvent(
																																																													player,
																																																															...
																																																															addSingleEvent(new SingleEvent(
																																																																...
																																																																public void action() {
																																																																	...
																																																																	addSingleEvent(new SingleEvent(
																																																																		...
																																																																		public void action() {
																																																																			sendChat(
																																																																					"Ouch! Would you bloody wait til I'm gone!",
																																																																					player,
																																																																					npc);
																																																																			player
																																																																					.setBusy(false);
