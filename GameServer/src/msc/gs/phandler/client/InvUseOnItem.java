...
import msc.gs.external.ItemArrowHeadDef;
import msc.gs.external.ItemBowStringDef;
import msc.gs.external.ItemDartTipDef;
import msc.gs.external.ItemGemDef;
import msc.gs.external.ItemHerbDef;
import msc.gs.external.ItemHerbSecond;
import msc.gs.external.ItemLogCutDef;
...
public class InvUseOnItem implements PacketHandler {
    ...
    private boolean doLogCut(Player player, final InvItem knife, final InvItem log) {
    	return doLogCut(player, knife, log, ((int)Math.ceil(player.getMaxStat(9) / 10)));
    }
	...
	if (item1.getID() == 223 && item2.getID() == 223 || item1.getID() == 223 && item2.getID() == 223) {
	...
	if (item1.getID() == 224 && item2.getID() == 224 || item1.getID() == 224 && item2.getID() == 224) {
	...
	else if (item1.getID() == 143 && item2.getID() == 141 || item1.getID() == 141 && item2.getID() == 143) {
	...
	if (item1.getID() == 141 && item2.getID() == 136 || item1.getID() == 136 && item2.getID() == 141) {
		...
		public void handleReply(final int option, final String reply) {
		    ...
		    if (owner.getInventory().remove(new InvItem(141)) > -1 && owner.getInventory().remove(new InvItem(136)) > -1) {
	...
	if (item2.getID() == 1276 && item1.getID() == 1277) {
	    ...
	    return;
	} else if ((item1.getID() == 23 && item2.getID() == 135) || (item2.getID() == 23 && item1.getID() == 135)) {
