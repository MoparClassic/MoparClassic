...
public class ImpCatcher extends Quest {
    ...
    private static final String[] FIRST_MENU = new String[] { "No way you crazy man", "Sure, why not" };
	...
	if (option == 1) {
	    ...
	    player.setBusy(true);
	    npc.blockedBy(player);
	    sendChat("There are four beads! Red, white, black, and yellow.", npc, player);
