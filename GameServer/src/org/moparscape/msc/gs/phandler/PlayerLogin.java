...
public class PlayerLogin implements PacketHandler {
    ...
    public void handlePacket(org.moparscape.msc.gs.connection.Packet p, IoSession session) throws Exception {
	...
	if (loginCode == 0 || loginCode == 1 || loginCode == 99) {
	    ...
	    org.moparscape.msc.gs.builders.MiscPacketBuilder sender = player.getActionSender();
